...
def get_watsonResponse():
    ...
    return all_disasters_keys[0], all_disaster_content[0], all_disasters_keys[1], all_disaster_content[1]

        

@app.route("/")
def index():
    disaster_title, disaster_content, disaster_title2, disaster_content2 = get_watsonResponse()
    return render_template("index.html", disaster_title = disaster_title, disaster_content = disaster_content, disaster_title2 = disaster_title2, disaster_content2 = disaster_content2)
